...
| Memory                    | Little to none between sessions | Retains context across steps and sessions |
| Takes action outside chat | No                              | Yes, bookings, updates, workflows         |
| Handles multi-step tasks  | No, single-turn                 | Yes, plans and executes steps             |
