const testimonialData = [
  ...
  },
  {
    ...
    name: "Subramanian",
    role: "Director",
    company: "ConvergirSystems",
    initials: "S",
    message:
      "Trimsel delivered a fast, modern website that ranks well on Google and clearly communicates what we do. Their digital marketing team took over SEO and paid campaigns, and within a few months we started seeing a consistent flow of inbound enquiries. They treat our marketing like it's their own — they track performance and actually care about the results.",
  },
  {
    id: 3,
    name: "Anand",
    ...
    initials: "A",
    message:
      "Trimsel built us a custom ticketing system that our service desk agents use daily across every client site — ticket assignment, priority routing, SLA tracking, and real-time reporting in one clean interface. Response times are faster, nothing falls through the cracks, and our clients can see exactly where their tickets stand.",
  },
  {
    id: 4,
    name: "Sathish",
