...
export const faqData = {
  ...
  default: [
    ...
    },
    {
      ...
      answer:
        "Yes, completely free, no commitment required. Our initial consultation is a 30-minute conversation where we listen to your project idea, ask the right questions, and give you an honest assessment of what it would take to build it. You'll leave with clarity on scope, timeline, and approach, whether you decide to work with us or not. Book yours using the form below.",
    },
    {
