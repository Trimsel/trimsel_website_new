...
export const metadata = {
  title: "Mocial Case Study | Social App Development | Trimsel",
  description:
    "How Trimsel built Mocial's social media application — platform architecture, feature development, and launch. Read the full development case study.",
  alternates: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Mocial social app case study by Trimsel",
      },
    ],
  },
  twitter: {
                ...
                <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
                    ...
                    <div className="z-10 mt-8">
                        ...
                        <p className="text-sm md:text-base font-medium text-black mb-6">
                            ...
                            <Link href="/portfolio" className="px-2 py-1 rounded-md transition-all duration-300 hover:-translate-y-0.5 hover:text-[#1896cd]n">
                                Portfolio
                            </Link>

                            {" • "}

                            <span className="px-2 py-1 rounded-md transition-all duration-300 hover:-translate-y-0.5 hover:text-[#1896cd]">Xaber</span>
                        </p>
