                ...
                <div className="relative flex flex-col items-center justify-center min-h-[500px] text-center px-4 pt-10">
                    ...
                    <div className="flex flex-wrap justify-center gap-6 mt-8">
                        {[
                            ...
                            <div key={i} className="flex items-center gap-2 text-md font-medium text-gray-700">
                ...
                <div className="grid grid-cols-2 gap-6 p-6 bg-[#f4f6f8] min-h-screen">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm">
                            <h3 className="text-md text-black font-semibold mb-4">QUICK CONTACT</h3>

                            <div className="grid grid-cols-2 gap-4">

                                {/* ITEM */}
                                <Link href="#" className="flex items-center justify-between border p-3 rounded-lg hover:bg-gray-50 transition">
                                    <div className="flex items-center gap-4">
                                        <Image src="/contactus5.svg" width={35} height={35} alt="" />
                                        <div>
                                            <p className="text-md font-medium">WhatsApp</p>
                                            <p className="text-sm text-gray-600 font-medium">Chat with us now</p>
                                        </div>
                                    </div>
                                ...
                                <Link href="#" className="flex items-center justify-between border p-3 rounded-lg hover:bg-gray-50 transition">
                                    <div className="flex items-center gap-4">
                                        <Image src="/contactus6.svg" width={35} height={35} alt="" />
                                        <div>
                                ...
                                <Link href="#" className="flex items-center justify-between border p-3 rounded-lg hover:bg-gray-50 transition">
                                    <div className="flex items-center gap-4">
                                        <Image src="/contactus7.svg" width={35} height={35} alt="" />
                                        <div>
                                            <p className="text-md font-medium">Email</p>
                                            <p className="text-sm text-gray-600 font-medium">hello@firmsite.com</p>
                                        </div>
                                    </div>
                                    <span className="text-gray-400 text-lg">{">"}</span>
                                </Link>
                                ...
                                <Link href="#" className="flex items-center justify-between border p-3 rounded-lg hover:bg-gray-50 transition">
                                    <div className="flex items-center gap-4">
                                        <Image src="/contactus14.svg" width={35} height={35} alt="" />
                                        <div>
                                            <p className="text-md font-medium">Schedule a Call</p>
                                            <p className="text-sm text-gray-600 font-medium">Book 30 min slot</p>
                                        </div>
                                    </div>
                                    <span className="text-gray-400 text-lg">{">"}</span>
                                </Link>
                        ...
                        <div className="bg-[#0f172a] text-white p-5 rounded-xl space-y-6">
                            <h5 className="text-md text-white font-semibold mb-4">SOCIAL PROOF</h5>
                        ...
                        <div className="bg-white p-5 rounded-xl shadow-sm space-y-6">
                            <h5 className="text-lg font-semibold mb-3 flex items-center gap-3">
                                <Image src="/contactus-response.svg" alt="bolt" width={20} height={20} className="opacity-80" />
                  ...
                  ${active === s.name
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div className="flex flex-col">
                                    <label className="text-md font-semibold text-gray-800 mb-1">Full Name</label>
                                    <input
                                ...
                                <div className="flex flex-col">
                                    <label className="text-md font-semibold text-gray-800 mb-1">Email</label>
                                    <input
                                ...
                                <div className="flex flex-col">
                                    <label className="text-md font-semibold text-gray-800 mb-1">Phone</label>
                                    <input
                                ...
                                <div className="flex flex-col">
                                    <label className="text-md font-semibold text-gray-800 mb-1">Company</label>
                                    <input
                            ...
                            <div className="flex flex-col">
                                <label className="text-md font-semibold text-gray-800 mb-1">Project Details</label>
                                <textarea
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="mt-4 text-base font-medium sm:text-lg">
                                ...
                                >
                                    ...
                                    KA Industrial Estate, Indira Nagar, Guindy,
