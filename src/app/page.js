            ...
            <div className="relative z-10 grid w-full items-center gap-6 sm:gap-10 md:grid-cols-2 lg:grid-cols-[58%_42%] xl:grid-cols-[55%_45%] md:gap-8 lg:gap-8 xl:gap-24 md:px-6 lg:pr-0 lg:pl-6 xl:pl-10">
              <div className="relative z-20 mt-6 text-center md:mt-10 lg:mt-16 md:text-left">
                ...
                <p className="mb-8 max-w-xl text-base sm:text-lg">
                  Trimsel helps startups, growing businesses, and enterprise
                  teams build custom software and AI-driven digital products
                  from intelligent mobile apps and scalable web platforms to
                  cloud infrastructure and DevOps automation. We handle the full
        ...
        <section className="bg-white text-black py-16">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <p className="mt-4 max-w-5xl mx-auto text-center text-black font-medium">
              ...
              digital marketing. We've helped startups turn their ideas into
              real products and worked with established businesses replacing
              systems that had outgrown their purpose. Wherever our clients are
              in their journey, we take time to understand their goals, build
              the right solution, and stay involved until it's delivered
              properly. With 200+ projects behind us and a 92% client retention
              rate, that approach speaks for itself.
            </p>
        ...
        <section className="bg-white py-8 md:min-h-screen md:flex md:flex-col md:justify-center md:py-16">
          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <p className="mt-4 max-w-3xl mx-auto text-center text-black font-medium">
              ...
              practical solution, and measurable outcomes. Browse the work and
              see how we approach different industries and challenges.
            </p>
          </div>
            ...
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-6 flex flex-col items-start text-left shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <p className="max-w-lg text-base text-black sm:text-lg">
                  ...
                  delivering solutions that fit their unique goals and
                  challenges.
                </p>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-6 flex flex-col items-start text-left shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <p className="max-w-xl text-base text-black sm:text-lg">
                  Whether you need a dedicated team, end-to-end delivery, or
                  extra hands on an existing project we adapt our approach to
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-6 flex flex-col items-start text-left shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <p className="max-w-xl text-base text-black sm:text-lg">
                  Design, development, DevOps, QA, and support all under one
                  roof, keeping communication clear and giving you full control
                  without the hassle.
                </p>
              </div>
            </div>
        ...
        <section className="bg-[#F5F6FF]">
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col items-center gap-4 text-center">
              ...
              <p className="mt-4 max-w-3xl mx-auto text-center text-black font-medium">
                From healthcare and on-demand platforms to logistics,
                e-commerce, and SaaS, our custom software development and mobile
                app teams bring the technical depth to build solutions that fit
                how your industry actually operates. We've delivered across 12+
