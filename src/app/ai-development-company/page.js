...
export default function AI() {
    return (
        <main>
            ...
            <section className="bg-[#f0efeb] px-10 py-16 rounded-3xl">
                ...
                <div className="mb-8">
                    ...
                    <h2 className="mt-4 text-center text-2xl md:text-4xl font-semibold">
                        Customize testing for your product with end-to-end software testing services
                    </h2>
                    ...
                    <p className="mt-4 max-w-5xl mx-auto text-center text-black font-medium">
                        ...
                        Testing within solid deadlines to deliver high-quality software to the
                        end customer.
                    </p>
                </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="relative bg-[#c9d6ea] rounded-xl p-6 overflow-hidden">
                            ...
                            <p className="mt-3 text-md font-medium text-gray-700 leading-relaxed">
                                ...
                                technology for agile and accurate testing. With simulated scenarios
                                and skilled QA experts, we are able to deduce issues, bugs and
                                errors and make timely and effective fixes.
                            </p>
                        </div>
                        ...
                        <div className="relative bg-[#ead7a4] rounded-xl p-6 overflow-hidden">
                            ...
                            <p className="mt-3 text-md font-medium text-gray-700 leading-relaxed">
                                Minitzon’s Manual Testing Services helps replicate user behaviour,
                                with consistent processes to eliminate all the bugs along the way.
                                Our tests cases and plans make the software testing assurance
                                services reliable, quality rich and error-free.
                            </p>
                        </div>
                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 items-stretch">
                    ...
                    <div className="ml-6">
                        <div>
                            ...
                            <p className="mt-4 text-gray-600">
                                ...
                                Application In Your Agile Environment.
                            </p>
                            ...
                            <div className="mt-6 space-y-5">
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <p className="text-sm text-gray-700">
                                        ...
                                        In alignment with your business needs translates to clear testing goals.
                                    </p>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <p className="text-sm text-gray-700">
                                        ...
                                        By improving the quality of your application, release on release.
                                    </p>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <p className="text-sm text-gray-700">
                                        ...
                                        Of your product health and testing efficacy by always available insights.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="bg-[#dbe7f3] rounded-2xl p-8 shadow-sm h-full flex flex-col">
                        ...
                        <p className="mt-4 text-gray-700 text-md font-medium leading-relaxed">
                            As a software testing services company, we test every part of the
                            application in your Agile environment. Testing is conducted frequently
                            while deployment steps are automated. The razor sharp focus is on the
                            business requirements, code quality, and security. Through QA and
                            testing services and adopting CI/CD, we ensure that the new features
                            are quickly tested and shipped to the market.
                        </p>
                    </div>
            ...
            <section className="bg-white py-12 md:py-20">
                <div className="flex justify-center px-4 sm:px-6">
                    <div className="relative w-full max-w-6xl rounded-xl bg-gradient-to-r from-[#0C0F14] via-black to-[#162D9C] shadow-lg flex flex-col md:flex-row items-center justify-between overflow-hidden">
                        {/* LEFT CONTENT */}
